            ...
            <div class="dashboard-grid">
                ...
                <div class="admin-card">
                    ...
                    <p class="card-description">
                        Gestiona la información de Hogares, como agregar, listar, actualizar, eliminar.
                    </p>
                    <a href="Controlador?menu=Hogar&accion=Listar" class="btn_ver_gestion">Gestionar Hogares</a>
                </div>
            </div>
        </div>
